...
- **Tasks:** Generate 250-300 word cover letter in Siva voice using 4-paragraph structure
...
2. **Select Best Insertion Point:**
   - Check Master Resume (`resume-master-content.md`) for existing mentions
